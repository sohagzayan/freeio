...
const NavSubMenu = ({ menu }: MenuItem) => {
    ...
    return (
        <div>
            <div>
                <h3 onMouseEnter={handleSub} onMouseLeave={handleSub} className='relative  font-[500]'>
                    ...
                    <AnimatePresence>
                        {activeSub && <motion.div
                            ...
                            className='absolute bg-skin-white_shade  font-[500]  top-6 left-0 flex  text-[14px] items-left flex-col z-10  shadow-primary_shadow  py-6 w-[200px]'>
